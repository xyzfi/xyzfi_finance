  ...
  constructor() {
    ...
    this.store = {
      ...
      rewardPools: [
        ...
        {
          id: 'Balancer',
          name: 'DAI/xyzFi balancer pool',
          website: 'pools.balancer.exchange',
          link: 'https://pools.balancer.exchange/#/pool/0xBe0511A7BFE956D63f4B0e49322057A88f27C09A', 
          depositsEnabled: false,
          tokens: [
            {
              id: 'bpt',
              address: '0xBe0511A7BFE956D63f4B0e49322057A88f27C09A',
              symbol: 'BPT',
              abi: config.erc20ABI,
              decimals: 18,
